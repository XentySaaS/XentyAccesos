...
const NAV_GROUPS: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/suscripcion",     label: "Suscripción",         roles: ["administrador"] },
...
function NavIcon({ label, active }: { label: string; active: boolean }) {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    "Suscripción":  <svg className={cls} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>,
