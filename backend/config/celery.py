...
app.conf.beat_schedule = {
    ...
    # los tenants, para no saturar el almacenamiento al escalar. Retención obligatoria 1–5 meses,
    # configurable por entorno (RETENCION_*_MESES) y por tenant (opciones retencion_*_meses).
