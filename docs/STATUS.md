...
| frontend-admin | ⚠ | **Dashboard control-plane** + lista Tenants + **detalle de tenant** (billing/checkout Stripe) + **Seguridad/MFA TOTP** (enrolar/activar + login con paso MFA). Falta: gestión de Planes, otorgar créditos |
